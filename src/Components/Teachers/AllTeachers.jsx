                            ...
                            <table className="table display data-table text-nowrap">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td className="text-center"><img src="/src/assets/img/figure/student2.png" alt="student" /></td>
                                        <td>Mark Willy</td>
                                        <td>Male</td>
                                        <td>2</td>
                                        <td>English</td>
                                    ...
                                    <tr>
                                        ...
                                        <td className="text-center"><img src="/src/assets/img/figure/student3.png" alt="student" /></td>
                                        <td>Jessia Rose</td>
                                        <td>Female</td>
                                        <td>1</td>
                                        <td>Mathematics</td>
                                    ...
                                    <tr>
                                        ...
                                        <td className="text-center"><img src="/src/assets/img/figure/student4.png" alt="student" /></td>
                                        <td>Mark Willy</td>
                                        <td>Male</td>
                                        <td>2</td>
                                        <td>Mathematics</td>
                                    ...
                                    <tr>
                                        ...
                                        <td className="text-center"><img src="/src/assets/img/figure/student5.png" alt="student" /></td>
                                        <td>Jessia Rose</td>
                                        <td>Female</td>
                                        <td>1</td>
                                        <td>Mathematics</td>
                                    ...
                                    <tr>
                                        ...
                                        <td className="text-center"><img src="/src/assets/img/figure/student6.png" alt="student" /></td>
                                        <td>Mark Willy</td>
                                        <td>Male</td>
                                        <td>2</td>
                                        <td>English</td>
                                    ...
                                    <tr>
                                        ...
                                        <td className="text-center"><img src="/src/assets/img/figure/student7.png" alt="student" /></td>
                                        <td>Jessia Rose</td>
                                        <td>Female</td>
                                        <td>1</td>
                                        <td>English</td>
                                    ...
                                    <tr>
                                        ...
                                        <td className="text-center"><img src="/src/assets/img/figure/student8.png" alt="student" /></td>
                                        <td>Mark Willy</td>
                                        <td>Male</td>
                                        <td>2</td>
                                        <td>Physics</td>
                                    ...
                                    <tr>
                                        ...
                                        <td className="text-center"><img src="/src/assets/img/figure/student9.png" alt="student" /></td>
                                        <td>Jessia Rose</td>
                                        <td>Female</td>
                                        <td>1</td>
                                        <td>Physics</td>
                                    ...
                                    <tr>
                                        ...
                                        <td className="text-center"><img src="/src/assets/img/figure/student10.png" alt="student" /></td>
                                        <td>Mark Willy</td>
                                        <td>Male</td>
                                        <td>2</td>
                                        <td>Physics</td>
